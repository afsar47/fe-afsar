...
export const protectedRoutes = [
    ...
    },
    {
        ...
        path: '/dealer/inventory/labor',
        component: lazy(() => import('@/views/Dealer/DealerInventory/Labor/Labor')),
        authority: ['dealer'],
    },
    {
        key: 'dealerInventory.item4',
        path: '/dealer/inventory/fees',
        component: lazy(() => import('@/views/Dealer/DealerInventory/Tires/Tires')),
        authority: ['dealer'],
    },
    {
    ...
    },
    {
        ...
        path: '/dealer/inventory/categories',
        component: lazy(() => import('@/views/Dealer/DealerInventory/Tires/Tires')),
        authority: ['dealer'],
    },
    {
        ...
        component: lazy(() => import('@/views/Dealer/Purchasing/PurchaseOrder')),
        authority: ['dealer'],
    },
    {
        key: 'dealerPurchasing.item2',
        path: '/dealer/purchasing/returns',
        component: lazy(() => import('@/views/Dealer/Purchasing/Returns')),
        authority: ['dealer'],
    },
    {
    ...
    // ... Lists
    {
        ...
        path: '/dealer/lists/line-item-categories',
        component: lazy(() => import('@/views/Dealer/DealerLists/Item1')),
        authority: ['dealer'],
    }, {
